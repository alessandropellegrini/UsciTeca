...
if(isset($_POST['seed']) && isset($_GET['confirm']) && $_POST['seed'] == $_GET['confirm']) {
	...
	if($_POST['aggiornamento'] == "") {
		$sql = "INSERT INTO `markers` (`lat`, `lng`, `nome`, `indirizzo`, `luogo`, `provincia`, `contatto`, `telefono`, `cellulare`, `email`, `tipo`, `posti`, `fuoco`, `acqua`, `campo`, `gratis`, `gioco`, `ombra`, `pending`, `inserimento`, `aggiornamento`) VALUES ('" . $_POST['latFld'] . "','" . $_POST['lngFld'] . "','" . $nome . "','" . $indirizzo . "','" . $luogo . "','" . $provincia ."','" . $contatto . "','" . $telefono . "','" . $cellulare . "','" . $email . "','" . $tipo . "','". $posti . "','" . $fuoco  . "','" . $acqua . "','" . $campo . "','" . $gratis ."','" . $gioco . "','" . $ombra . "', '1', null, null)";
	} else {
